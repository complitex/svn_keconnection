...
import org.complitex.keconnection.heatmeter.web.correction.component.edit.AddressCorrectionInputPanel;
...
public class AddressCorrectionEdit extends FormTemplatePage {
    ...
    private class StreetCorrectionEditPanel extends AddressCorrectionEditPanel {
        ...
        protected StreetCorrection newObjectCorrection(String entity) {
            ...
            c.setUserOrganizationId(keConnectionSessionBean.getCurrentUserOrganizationId(getTemplateSession()));
            return c;
        }
