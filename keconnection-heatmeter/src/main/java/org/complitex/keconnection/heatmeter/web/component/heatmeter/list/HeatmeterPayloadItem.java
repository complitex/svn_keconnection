    ...
    public HeatmeterPayloadItem(String id, final IModel<BigDecimal> payloadModel, boolean editable) {
        ...
        Label label = new Label("label", new AbstractReadOnlyModel<String>() {
            ...
            public String getObject() {
                ...
                NumberFormat formatter = new DecimalFormat("##0.##", DecimalFormatSymbols.getInstance(getLocale()));
        ...
        TextField<BigDecimal> input = new TextField<BigDecimal>("input", payloadModel);
