...
CREATE TABLE `tarif_group_attribute` (
  ...
  KEY `key_end_date` (`end_date`),
  KEY `key_status` (`status`),
  CONSTRAINT `fk_tarif_group_attribute__ownership` FOREIGN KEY (`object_id`) REFERENCES `tarif_group`(`object_id`),
...
CREATE TABLE `tarif_attribute` (
  ...
  KEY `key_end_date` (`end_date`),
  KEY `key_status` (`status`),
  CONSTRAINT `fk_tarif_attribute__ownership` FOREIGN KEY (`object_id`) REFERENCES `tarif`(`object_id`),
