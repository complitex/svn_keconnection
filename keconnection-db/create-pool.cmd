...
ECHO.
ECHO Register the JDBC connection pool
call %GLASSFISH_ASADMIN% create-jdbc-connection-pool --driverclassname oracle.jdbc.OracleDriver --restype java.sql.Driver --property url=jdbc\:oracle\:thin\:@192.168.1.102\:1521\:cnkiev:user=comp:password=comp:characterResultSets=utf8:characterEncoding=utf8:useUnicode=true keconnectionRemotePool

ECHO.
ECHO Create a JDBC resource with the specified JNDI name
call %GLASSFISH_ASADMIN% create-jdbc-resource --connectionpoolid keconnectionRemotePool jdbc/keconnectionRemoteResource 
